...
from xgboost3 import XGBClassifier
from sklearn.metrics import accuracy_score, recall_score, precision_score, f1_score, classification_report


file_path = 'C:/Users/bhavy/Desktop/Minor Project Sem 5/combined_manual.xlsx'  # Update with your file path
...
model = XGBClassifier(colsample_bytree=1.0,gamma=1,learning_rate=0.01,max_depth=7, random_state=42, n_estimators=200,subsample=0.8)
...
prob_df.to_excel('test_probabilities.xlsx', index=False)
...
query_pred = model.predict(query_df)
query_prob = model.predict_proba(query_df)

print(f"Prediction for query vector: {query_pred[0]}")
print(f"Probability of 0: {query_prob[0][0]}, Probability of 1: {query_prob[0][1]}")
